...
// setup_2fa_page.php/bookmarklet_page.php (VI.3) and activate_page.php (SEC-134).
// This page embeds a still-valid, single-use email-change token plus a working
// CSRF field in rendered HTML - without this header a browser's back/forward
// cache (bfcache) could replay a stale render of this exact confirm form on a
// shared/public machine after the token has already been consumed or expired
// server-side.
