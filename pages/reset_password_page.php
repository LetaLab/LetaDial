...
// confirm_email_page.php (SEC-134). This page embeds a still-valid, single-use
// password reset token plus a working CSRF field in rendered HTML - without this
// header a browser's back/forward cache (bfcache) could replay a stale render of
// this exact form on a shared/public machine after the token has already been
// consumed or expired server-side.
